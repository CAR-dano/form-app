          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                ToggleOption(label: 'Buku Service'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'Kunci Serep'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'Buku Manual'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'Ban Serep'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'BPKP'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'Dongkrak'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'Toolkit'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'No Rangka'),
                const SizedBox(height: 16.0),
                ToggleOption(label: 'No Mesin'),
